...
# TODO
1. Create a BundleComponent for old BundleAdapter. The BundleComponent interface will extend the Component interaface (like it was done for Aspects/Adapters).
2. Do the same for the ResourceAdapter.
