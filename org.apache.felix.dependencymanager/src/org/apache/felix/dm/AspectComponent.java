...
public interface AspectComponent extends Component<AspectComponent> {
     ...
     * @param serviceFilter the filter condition to use with the service aspect interface (null if no filter)
     * @param ranking  the level used to organize the aspect chain ordering
     * @return this aspect parameter instance
     */
	AspectComponent setAspect(Class<?> serviceInterface, String filter, int ranking);
