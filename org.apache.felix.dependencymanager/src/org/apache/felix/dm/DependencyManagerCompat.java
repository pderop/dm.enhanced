...
public abstract class DependencyManagerCompat {
     ...
     * 
     * <blockquote><pre>
     * manager.createAspectComponent()
     *        .service(ExistingService.class).ranking(10))
     *        .setImplementation(ExistingServiceAspect.class)
     * );
     * </pre></blockquote>
     * 
     * @param consumer a block of code called with an AspectComponentParams object that you can use
     *        to configure the various aspect component parameters.
     ...
     * 
     * <blockquote><pre>
     * manager.createAdapterComponent(params -> params.service(AdapteeService.class).filter("(foo=bar)"))
     *     .setInterface(AdapterService.class, null)
     *     .setImplementation(AdapterImpl.class);
     * </pre></blockquote>
     * 
     * @param consumer a block of code called with an AspectComponentParams object that you can use to configure the various aspect component parameters.
     ...
     * <li> updated(Configuration Types)
     * </ul>
     * 
     * <p>Usage example:
     * 
     * <blockquote><pre>
     *  manager.createFactoryComponent(param -> params.factoryPid("my.factorypid"))
     *         .setInterface(MyService.class.getName(), null)
     *         .setImplementation(MyServiceImpl.class);
     * </pre></blockquote>
     * 
     * @param paramsConsumer a java8 consumer which takes as argument a @link {@link FactoryComponentParams} argument that
     * is used to set the various parameters specific to Factory Components (factory pid, etc ...).
